...
#define FIFO_DIS_INT() //NVIC_DisableIRQ(USART2_IRQn)//disableInterrupts() //disable interrupt
#define FIFO_EN_INT()  //NVIC_EnableIRQ(USART2_IRQn)//enableInterrupts() //enable interrupt again.
